import {alertMessage, initMaxLength} from '../common/utils';
...
const TherapistModify = (function () {
    let therapistsEl;
    let therapistFormEl;
    let showTherapistFormButtonEl;
    let inputIndexEl;
    let inputNameEl;
    let inputPositionEl;
    ...
    const functions = {
        isFormWriting: async () => {
            let formDisplay = therapistFormEl.style.display;
            const valid = await validator.validate();

            return formDisplay === "block" && valid !== FORM_VALID;
        },

        setTherapists: (sessionTherapists) => {
            therapists = sessionTherapists;
        }
    }
    ...
    const handlers = {
        ...
        showModifyForm: (index) => {
            ...
            handlers.showTherapistForm('modify');
        },
        ...
        showTherapistForm: (type) => {
            ...
            therapistFormEl.style.display = 'block';
        },

        hideRegisterForm: () => {
            therapistFormEl.style.display = 'none';
        },
    ...
    const init = () => {
        ...
        therapistFormEl = document.querySelector("#therapistForm");
        showTherapistFormButtonEl = document.querySelector("#showTherapistFormButton");
        ...
        showTherapistFormButtonEl.addEventListener('click', handlers.showTherapistForm);
    ...
    return {
        init,
        setTherapists: functions.setTherapists
    }
})();

window.TherapistModify = TherapistModify;
