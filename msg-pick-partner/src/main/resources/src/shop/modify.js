...
const ShopModify = (function () {
    let shopModifyFormEl;
    let selectTypeEl;
    ...
    const init = () => {
        shopModifyFormEl = document.querySelector("#shopModifyFormEl");
        ...
        shopModifyButtonEl = document.querySelector("#shopModifyButton");
        ...
        shopModifyButtonEl.addEventListener('click', handlers.onClickModify);
