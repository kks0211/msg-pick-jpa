import {initMaxLength, removeComma, setComma} from '../common/utils';
import {FORM_VALID} from '../common/constants';

const ProgramModify = (function () {
    let programsEl;
    let programFormEl;
    let showProgramFormButtonEl;
    let inputIndexEl;
    let inputNameEl;
    let inputPriceEl;
    ...
    const functions = {
        isFormWriting: async () => {
            let formDisplay = programFormEl.style.display;
    ...
    const handlers = {
        ...
        addProgram: async () => {
            ...
            if (valid === FORM_VALID) {
                ...
                programFormEl.style.display = 'none';
            }
        },
        ...
        showRegisterForm: (type) => {
            ...
            programFormEl.style.display = 'block';
        },
    ...
    const init = () => {
        ...
        programFormEl = document.querySelector("#programForm");
        showProgramFormButtonEl = document.querySelector("#showProgramFormButton");
...
ø
        ...
        showProgramFormButtonEl.addEventListener('click', handlers.showRegisterForm);
...
window.ProgramModify = ProgramModify;
